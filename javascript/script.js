...
//  names = parseInt(prompt("enter the names"));

//  dd = parseInt(prompt("enter the day:"));
// if ((dd < 0)||(dd > 31)){
//     document.getElementById("p1").innerHTML="This day is invalid";
// }
//  mm = parseInt(prompt("enter the month:"));
// if ((mm < 0) || (mm > 12)) {
//     document.getElementById("p1").innerHTML="This month is invalid";
// }
//  yy = parseInt(prompt("enter the year:"));
// if(yy < 1900){
//     document.getElementById("p1").innerHTML="you are older!";
// }
//  cc = parseInt(prompt("enter the century:"));
//  gender = parseInt(prompt("enter your gender"));
